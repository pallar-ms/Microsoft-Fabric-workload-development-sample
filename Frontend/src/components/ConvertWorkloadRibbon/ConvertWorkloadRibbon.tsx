...
import { callDatahubOpen, callDialogOpenMsgBox } from '../../controller/ConvertWorkloadController';
import './../../styles.scss';
import { ItemTabToolbar } from "./ItemTabToolbar";
import { callItemGet, callOpenSettings } from "../../controller/ConvertWorkloadController";
...
const { itemObjectId, workloadClient } = props;
  ...
  async function onDatahubClicked() {
    ...
    await callDatahubOpen("Select a Lakehouse to use for Convert Workload", true, props.workloadClient);
  }
